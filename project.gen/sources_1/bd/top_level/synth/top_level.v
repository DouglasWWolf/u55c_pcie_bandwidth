...
module pcie1_bridge_imp_1YH9ZFK
  ...
  wire [31:0]axi4_master_plug_0_AXI_ARADDR;
  wire axi4_master_plug_0_AXI_ARREADY;
  wire axi4_master_plug_0_AXI_ARVALID;
  wire [31:0]axi4_master_plug_0_AXI_AWADDR;
  wire axi4_master_plug_0_AXI_AWREADY;
  wire axi4_master_plug_0_AXI_AWVALID;
  wire axi4_master_plug_0_AXI_BREADY;
  wire [1:0]axi4_master_plug_0_AXI_BRESP;
  wire axi4_master_plug_0_AXI_BVALID;
  wire [31:0]axi4_master_plug_0_AXI_RDATA;
  wire axi4_master_plug_0_AXI_RREADY;
  wire [1:0]axi4_master_plug_0_AXI_RRESP;
  wire axi4_master_plug_0_AXI_RVALID;
  wire [31:0]axi4_master_plug_0_AXI_WDATA;
  wire axi4_master_plug_0_AXI_WREADY;
  wire axi4_master_plug_0_AXI_WVALID;
  ...
  top_level_axi4_master_plug_0_0 axi4_master_plug
       (.AXI_ARADDR(axi4_master_plug_0_AXI_ARADDR),
        .AXI_ARREADY(axi4_master_plug_0_AXI_ARREADY),
        .AXI_ARVALID(axi4_master_plug_0_AXI_ARVALID),
        .AXI_AWADDR(axi4_master_plug_0_AXI_AWADDR),
        .AXI_AWREADY(axi4_master_plug_0_AXI_AWREADY),
        .AXI_AWVALID(axi4_master_plug_0_AXI_AWVALID),
        .AXI_BREADY(axi4_master_plug_0_AXI_BREADY),
        .AXI_BRESP(axi4_master_plug_0_AXI_BRESP),
        .AXI_BVALID(axi4_master_plug_0_AXI_BVALID),
        .AXI_RDATA(axi4_master_plug_0_AXI_RDATA),
        .AXI_RREADY(axi4_master_plug_0_AXI_RREADY),
        .AXI_RRESP(axi4_master_plug_0_AXI_RRESP),
        .AXI_RVALID(axi4_master_plug_0_AXI_RVALID),
        .AXI_WDATA(axi4_master_plug_0_AXI_WDATA),
        .AXI_WREADY(axi4_master_plug_0_AXI_WREADY),
        .AXI_WVALID(axi4_master_plug_0_AXI_WVALID),
        .clk(xdma_0_axi_aclk));
  ...
  top_level_pcie_bridge_0_0 pcie_bridge
       (.axi_aclk(xdma_0_axi_aclk),
        ...
        .s_axil_araddr(axi4_master_plug_0_AXI_ARADDR),
        .s_axil_arprot({1'b0,1'b0,1'b0}),
        .s_axil_arready(axi4_master_plug_0_AXI_ARREADY),
        .s_axil_arvalid(axi4_master_plug_0_AXI_ARVALID),
        .s_axil_awaddr(axi4_master_plug_0_AXI_AWADDR),
        .s_axil_awprot({1'b0,1'b0,1'b0}),
        .s_axil_awready(axi4_master_plug_0_AXI_AWREADY),
        .s_axil_awvalid(axi4_master_plug_0_AXI_AWVALID),
        .s_axil_bready(axi4_master_plug_0_AXI_BREADY),
        .s_axil_bresp(axi4_master_plug_0_AXI_BRESP),
        .s_axil_bvalid(axi4_master_plug_0_AXI_BVALID),
        .s_axil_rdata(axi4_master_plug_0_AXI_RDATA),
        .s_axil_rready(axi4_master_plug_0_AXI_RREADY),
        .s_axil_rresp(axi4_master_plug_0_AXI_RRESP),
        .s_axil_rvalid(axi4_master_plug_0_AXI_RVALID),
        .s_axil_wdata(axi4_master_plug_0_AXI_WDATA),
        .s_axil_wready(axi4_master_plug_0_AXI_WREADY),
        .s_axil_wstrb({1'b1,1'b1,1'b1,1'b1}),
        .s_axil_wvalid(axi4_master_plug_0_AXI_WVALID),
        .sys_clk(util_ds_buf_0_IBUF_DS_ODIV2),
        .sys_clk_gt(util_ds_buf_0_IBUF_OUT),
        .sys_rst_n(sys_rst_n_0_1),
        .usr_irq_req(1'b0));
